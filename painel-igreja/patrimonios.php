...
<div class="row my-3" style="margin-right:20px">
	<div class="col-md-2">
		<a href="#" onclick="inserir()" type="button" class="btn btn-success btn-sm">Novo Item</a>
	</div>

	<div class="col-md-10" align="right">
		<small><small>
			<span class="mx-2 text-white"><i class="bi bi-circle-fill text-dark"></i> Item da Igreja </span>
			<span class="mx-2 text-white"><i class="bi bi-circle-fill text-danger"></i> Item Emprestado </span>
			<span class="mx-2 text-white"><i class="bi bi-circle-fill text-primary"></i> Item de outra Igreja </span>
			<span class="mx-2 text-white"><i class="bi bi-circle-fill text-muted"></i> Item Inativo </span>
		</small></small>
	</div>
</div>
						...
						<td>
							<big>
								...
								<a href="#" onclick="mudarStatus('<?php echo $id ?>', '<?php echo $ativar ?>')" title="<?php echo $ativo ?>">
									...
									<a class="<?php echo $ocultar_transferir ?>" href="#" onclick="transferir('<?php echo $id ?>' , '<?php echo $nome ?>')" title="Transferir Item">	<i class="bi bi-truck text-danger"></i> </a>

									<a class="<?php echo $ocultar_devolucao ?>" href="#" onclick="devolver('<?php echo $id ?>' , '<?php echo $nome ?>', '<?php echo $igreja_cad ?>')" title="Devolver Item">	<i class="bi bi-truck text-success"></i> </a>
