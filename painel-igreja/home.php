...
<div class="container-fluid mt-4" >
	<section id="minimal-statistics" style="margin-right:20px">
		...
		<div class="row mb-2 <?php echo $esc_secretario ?>">
			<div class="col-10 mt-3 mb-1">
				<h4 class="text-uppercase textocinzaescuro"><small><small class="text-white"><?php echo $nome_igreja ?> </small></small></h4>
			</div>

			<div class="col-2 mt-3 mb-1" align="right">
				<small class="text-white">Saldo Mês : <span class="<?php echo $classeSaldo ?>">R$ <?php echo $saldoMes ?></span></small>
			</div>
		</div>
		...
		<div class="row mb-4">
			...
			<div class="col-xl-3 col-sm-6 col-12 linkcard mb-2 <?php echo $esc_secretario ?>"> 
				<a href="index.php?pag=dizimos">
					<div class="card bg-card-igrejas ">
						<div class="card-content text-white">
							<div class="card-body">
								<div class="row">
									<div class="align-self-center col-3">
										<i class="bi bi-piggy-bank text-white fs-1 float-start"></i>
									</div>
									<div class="col-9 text-end">
										<h3> <span class="text-white">R$ <?php echo @$totalDizimos ?></span></h3>
										<span class="text-white">Dízimos do Mês</span>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="card bg-card-igrejas">
						<div class="card-content text-white">
							<div class="card-body">
								<div class="row">
									<div class="align-self-center col-3">
										<i class="bi bi-cash text-white fs-1 float-start"></i>
									</div>
									<div class="col-9 text-end">
										<h3> <span class="text-white">R$ <?php echo @$totalOfertas ?></span></h3>
										<span class="text-white">Ofertas do Mês</span>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="card bg-card-igrejas">
						<div class="card-content text-white">
							<div class="card-body">
								<div class="row">
									<div class="align-self-center col-3">
										<i class="bi bi-currency-dollar text-white fs-1 float-start"></i>
									</div>
									<div class="col-9 text-end">
					...
					<div class="card bg-card-igrejas">
						<div class="card-content text-white">
							<div class="card-body">
								<div class="row">
									<div class="align-self-center col-3">
										<i class="bi bi-cash-coin text-white fs-1 float-start"></i>
									</div>
									<div class="col-9 text-end">
										<h3> <span class="text-success">R$ <?php echo @$totalVendas ?></span></h3>
										<span class="text-white">Vendas do Mês</span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card-content text-white">
							<div class="card-body">
								<div class="row">
									...
									<div class="col-9 text-end">
										<h3> <span class="text-white">R$ <?php echo @$totalDoacoes ?></span></h3>
										<span class="text-white">Doações do Mês</span>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="card bg-card-igrejas">
						<div class="card-content text-white">
							<div class="card-body">
								<div class="row">
									<div class="align-self-center col-3">
										<i class="bi bi-people-fill text-white fs-1 float-start"></i>
									</div>
									<div class="col-9 text-end">
										<h3> <span class="text-white"><?php echo @$membrosCadastrados ?></span></h3>
										<span class="text-white">Total de Membros</span>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="card bg-card-igrejas">
						<div class="card-content text-white">
							<div class="card-body">
								<div class="row">
									<div class="align-self-center col-3">
										<i class="bi bi-person-lines-fill text-white fs-1 float-start"></i>
									</div>
									<div class="col-9 text-end">
										<h3> <span class="text-white"><?php echo @$gruposCadastrados ?></span></h3>
										<span class="text-white">Total de Grupos</span>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="card bg-card-igrejas">
						<div class="card-content text-white">
							<div class="card-body">
								<div class="row">
									<div class="align-self-center col-3">
										<i class="bi bi-person-plus text-white fs-1 float-start"></i>
									</div>
									<div class="col-9 text-end">
										<h3> <span class="text-white"><?php echo @$celulasCadastradas ?></span></h3>
										<span class="text-white">Total de Células</span>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="card bg-card-igrejas">
						<div class="card-content text-white">
							<div class="card-body">
								<div class="row">
									<div class="align-self-center col-3">
										<i class="bi bi-box text-white fs-1 float-start"></i>
									</div>
									<div class="col-9 text-end">
										<h3> <span class="text-white"><?php echo @$patCadastrados ?></span></h3>
										<span class="text-white">Patrimônio / Itens</span>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="card bg-card-igrejas">
						<div class="card-content text-white">
							<div class="card-body">
								<div class="row">
									<div class="align-self-center col-3">
										<i class="bi bi-calendar-week text-white fs-1 float-start"></i>
									</div>
									<div class="col-9 text-end">
										<h3> <span class="text-white"><?php echo @$pagarHoje ?></span></h3>
										<span class="text-white">Contas à Pagar Hoje</span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card-content text-white">
							<div class="card-body">
								<div class="row">
									...
									<div class="col-9 text-end">
										<h3> <span class="text-white"><?php echo @$receberHoje ?></span></h3>
										<span class="text-white">Contas à Receber Hoje</span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								<div class="row">
									...
									<div class="col-9 text-end">
										...
										<span class="text-white">Contas à Pagar Vencidas</span>
									</div>
								</div>
							</div>
						</div>
	...
	<!--
		<div class="<?php echo $esc_tesoureiro ?> <?php echo $esc_secretario ?>" align="right"><a href="index.php?mostrar=<?php echo $mostrar ?>"><i class="bi <?php echo $icone_plus ?> text-white"></i></a></div>
		</div>
	-->
	</section>
	...
	<div class="text-xs font-weight-bold text-secondary text-uppercase mt-2"><small class="text-white">AGENDA / <?php echo $total_reg ?> TAREFAS PENDENTES</small></div>
	<hr> 
