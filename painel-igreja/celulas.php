...
<div class="col-md-12 my-3">
	<a href="#" onclick="inserir()" type="button" class="btn btn-success btn-sm">Nova Célula</a>
</div>
			...
			<tbody>
				...
				for($i=0; $i < $total_reg; $i++){
					...
					<tr>
						...
						<td>
							<big>
								<a href="#" onclick="editar('<?php echo $id ?>', '<?php echo $nome ?>', '<?php echo $dias ?>', '<?php echo $hora ?>', '<?php echo $local ?>', '<?php echo $pastor ?>', '<?php echo $coordenador ?>', '<?php echo $lider1 ?>', '<?php echo $lider2 ?>')" title="Editar Registro">	<i class="bi bi-pencil-square text-primary"></i> </a>

								<a href="#" onclick="excluir('<?php echo $id ?>' , '<?php echo $nome ?>')" title="Excluir Registro">	<i class="bi bi-trash text-danger"></i> </a>

								<a href="#" onclick="dados('<?php echo $nome ?>', '<?php echo $dias ?>', '<?php echo $hora ?>', '<?php echo $local ?>', '<?php echo $nome_pastor ?>', '<?php echo $nome_coordenador ?>', '<?php echo $nome_lider1 ?>', '<?php echo $nome_lider2 ?>', '<?php echo $obs ?>', '<?php echo $membros_celula ?>')" title="Ver Dados">	<i class="bi bi-info-square-fill text-primary"></i> </a>
		...
		<div class="modal-content">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<span class=""><b>Coordenador:</b> <span id="coordenador-dados"></span></span>
								<hr style="margin:4px">
			...
			<div class="modal fade" id="modalAddMembros" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
				...
				<script type="text/javascript">
					...
					function dados(nome, dias, hora, local, pastor, coordenador, lider1, lider2, obs, membros){
