...
<body class="body-igrejas">

<!--	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			<a class="navbar-brand" href="painel-admin"><img src="../img/igrejas/<?php echo $foto_igreja ?>" width="40px" height="40px"></a>
...
<header>
    <div class="px-3 py-1 nav-menu-igrejas text-white">
      <div class="container-fluider">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
			<a class="d-flex align-items-center mx-4 my-2 my-lg-0 me-lg-auto text-white text-decoration-none" href="index.php"><img src="../img/igrejas/<?php echo $foto_igreja ?>" width="45px"> </a>
          ...
          <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            ...
            <li class="nav-item dropdown">
				<a href="#" class=" nav-link link-white foto text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
					<img src="../img/membros/<?php echo $foto_usu ?>" alt="mdo" width="45" height="45" class=" max-auto bi mt-1 rounded-circle">
				</a>
				<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
								<li><a class="dropdown-item" data-bs-toggle="modal" ><?php echo @$nome_usu ?></a></li>				
								<li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modalPerfil">Editar Dados</a></li>
