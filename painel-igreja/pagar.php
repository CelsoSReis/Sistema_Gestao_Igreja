...
<div class="row my-3">
	<div class="col-md-2">
		<a href="#" onclick="inserir()" type="button" class="btn btn-success btn-sm">Nova Conta</a>
	</div>

	
	<div class="col-md-10 mt-1">
		<small class="text-white">
		<a href="index.php?pag=<?php echo $pagina ?>" class="<?php echo $classe_todas ?> text-white"> Todas </a> /
		<a href="index.php?pag=<?php echo $pagina ?>&filtrar=Vencidas" class="<?php echo $classe_vencidas ?> text-white"> Vencidas </a> / 
		<a href="index.php?pag=<?php echo $pagina ?>&filtrar=Hoje" class="<?php echo $classe_hoje ?> text-white"> Vencendo Hoje </a> 
