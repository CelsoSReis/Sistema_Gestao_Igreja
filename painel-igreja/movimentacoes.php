...
<div class="row my-3">
	...
	<div class="col-md-12 text-white">
		...
		<a href="index.php?pag=<?php echo $pagina ?>&filtrar=Entradas" class="<?php echo $classe_entradas ?> text-white"> Entradas </a> / 
		<a href="index.php?pag=<?php echo $pagina ?>&filtrar=Saídas" class="<?php echo $classe_saidas ?> text-white"> Saídas </a> 
