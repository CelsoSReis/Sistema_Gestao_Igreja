...
if($id == "" || $id == 0){
	...
	if($imagem == "sem-foto.jpg"){
		$query = $pdo->prepare("UPDATE $pagina SET nome = :nome, telefone = :telefone, endereco = :endereco, pastor = '$pastor', video = :video, email = :email where id = '$id'");
	}else{
		...
		$query = $pdo->prepare("UPDATE $pagina SET nome = :nome, telefone = :telefone, endereco = :endereco, imagem = '$imagem', pastor = '$pastor', video = :video, email = :email where id = '$id'");
	}
