...
<div class="col-md-12 my-3">
	<a href="#" onclick="inserir()" type="button" class="btn btn-success btn-sm">Novo Pastor</a>
</div>
			...
			<tbody>
				...
				for($i=0; $i < $total_reg; $i++){
					...
					<tr>
						...
						<td>
							<a href="#" onclick="editar('<?php echo $id ?>', '<?php echo $nome ?>', '<?php echo $cpf ?>', '<?php echo $email ?>', '<?php echo $telefone ?>', '<?php echo $endereco ?>', '<?php echo $foto ?>', '<?php echo $data_nasc ?>', '<?php echo $igreja ?>', '<?php echo $nome_ig ?>')" title="Editar Registro">	<i class="bi bi-pencil-square text-primary"></i> </a>
